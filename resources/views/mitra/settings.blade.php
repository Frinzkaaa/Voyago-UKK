...
@section('content')
    <div class="mb-8">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Akun & Preferensi</h2>
        <p class="text-sm text-gray-500 dark:text-[#A1A1AA] mt-1">Kelola identitas bisnis dan konfigurasi finansial mitra</p>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div class="lg:col-span-8 space-y-8">
            <div class="premium-card p-6 bg-white dark:bg-dark-card border border-gray-100 dark:border-dark-border transition-colors duration-300">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" value="{{ Auth::user()->email }}" disabled
                                class="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-dark-border p-3 rounded text-sm font-medium text-gray-400 cursor-not-allowed">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <textarea rows="3" placeholder="Gambarkan keunggulan layanan bisnis Anda..."
                            class="w-full bg-gray-50 border border-gray-200 dark:border-dark-border focus:border-orange-500 focus:bg-white dark:bg-dark-card p-3 rounded outline-none transition-all text-sm font-medium resize-none transition-colors duration-300"></textarea>
                    </div>
                </div>
            </div>
