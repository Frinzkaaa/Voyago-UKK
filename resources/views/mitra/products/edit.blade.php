            ...
            <div class="lg:col-span-8 space-y-10">
                ...
                <div class="bg-white dark:bg-zinc-900 p-10 rounded-[40px] border border-gray-100 dark:border-zinc-800 shadow-sm relative overflow-hidden group">
                    ...
                    <textarea name="terms" rows="4"
                        class="w-full bg-gray-50 dark:bg-zinc-950/50 border border-gray-100 dark:border-zinc-800 focus:border-orange-500 rounded-[32px] py-6 px-8 outline-none transition-all text-sm font-bold text-gray-900 dark:text-white leading-relaxed resize-none shadow-sm">{{ $product->terms ?? '' }}</textarea>
                </div>
            </div>
            ...
            <div class="lg:col-span-4 space-y-10">
                ...
                <div class="bg-white dark:bg-zinc-900 p-10 rounded-[40px] border border-gray-100 dark:border-zinc-800 shadow-sm">
                    ...
                    <div class="space-y-10">
                        <!-- Primary Image -->
                        <x-form.image-uploader name="image" label="Foto Utama (Cover)" helper="Akan tampil di card pencarian utama. Rasio 16:9 direkomendasikan." :value="$product->image" />

                        <!-- Gallery Images -->
                        <div class="pt-8 border-t border-gray-50 dark:border-zinc-800">
                             <x-form.image-uploader name="gallery" label="Galeri Foto Tambahan" helper="Bisa pilih banyak gambar sekaligus untuk detail produk." :multiple="true" :value="$product->gallery" />
                        </div>
                    </div>
                </div>
