...
@section('content')
    <div class="max-w-[1280px] mx-auto space-y-8">
        ...
        <div
            class="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
                ...
                <div class="text-center md:text-left">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-2">
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <p class="text-sm font-black text-gray-700">{{ auth()->user()->points }} <span
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
            <div
                class="bg-white p-6 rounded-[24px] shadow-sm border border-gray-100 flex items-center gap-4 group hover:border-orange-100 transition-all">
                <div
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-800">{{ $stats['total_trips'] }}</p>
            ...
            <div
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-800">{{ $stats['destinations'] }}</p>
            ...
            <div
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-800">{{ $stats['planning_rooms'] }}</p>
            ...
            <div
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-800">{{ $stats['wishlist'] }}</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100">
                    <h2 class="text-xl font-bold text-gray-800 mb-6">Aktivitas Terakhir</h2>
                    <div class="space-y-6">
                        @foreach($activities as $activity)
                            <div onclick="{{ $activity['type'] == 'booking' ? 'showOrderDetail(' . json_encode($activity['raw']) . ')' : '' }}"
                                class="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl hover:bg-gray-50 transition-all {{ $activity['type'] == 'booking' ? 'cursor-pointer' : '' }}">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#FF7304] shadow-sm">
                                        <i class="fa-solid {{ $activity['icon'] }}"></i>
                                    </div>
                                    <div>
                                        <p class="font-bold text-gray-800 text-sm">{{ $activity['title'] }}</p>
                ...
                <div id="orderModal" class="fixed inset-0 z-[9999] hidden overflow-y-auto">
                    ...
                    <div class="relative min-h-screen flex items-center justify-center p-4"
                        ...
                        <div class="bg-white rounded-[2rem] overflow-hidden shadow-2xl w-full max-w-xl relative">
                            <!-- Header -->
            ...
            <div class="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-xl font-bold text-gray-800">Destinasi Favorit</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="group cursor-pointer">
                        <div class="relative h-32 rounded-[20px] overflow-hidden mb-3">
                            ...
                            <div
                                class="absolute top-2 right-2 w-7 h-7 bg-white rounded-full flex items-center justify-center text-red-500 shadow-md">
                                <i class="fa-solid fa-heart text-[10px]"></i>
                            </div>
                        </div>
                        <h3 class="font-bold text-gray-800 text-sm truncate">Bali, Indonesia</h3>
                    ...
                    <div class="group cursor-pointer">
                        ...
                        <h3 class="font-bold text-gray-800 text-sm truncate">Kyoto, Japan</h3>
                    ...
                    <div class="group cursor-pointer">
                        ...
                        <h3 class="font-bold text-gray-800 text-sm truncate">Swiss Alps</h3>
        ...
        <div class="space-y-8">
            <div class="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold text-gray-700">{{ auth()->user()->phone ?? 'Belum diatur' }}</p>
                    </div>
                    <div>
                ...
                <div class="mt-10">
                    <a href="/settings"
                        class="block w-full text-center px-6 py-3 border-2 border-orange-100 text-[#FF7304] font-bold rounded-2xl hover:bg-orange-50 transition-all text-sm">Update
                        Profil</a>
                </div>
            </div>
            ...
            <div class="bg-[#FF7304] rounded-[24px] p-8 shadow-lg shadow-orange-100 text-white relative overflow-hidden">
                ...
                <p class="text-xs text-white/80 mb-6 relative">Kamu sudah melakukan 12 perjalanan. Kumpulkan 3 lagi
                    untuk Gold Member!</p>
                <div class="w-full bg-white/20 h-2 rounded-full mb-2 relative">
                    <div class="bg-white w-[75%] h-full rounded-full"></div>
                </div>
