<div class="flex flex-col gap-6">
  <div class="flex flex-col gap-4">
    ...
    <div class="flex items-center justify-between">
      <div class="flex flex-wrap gap-2">
        ...
        <button
          class="bg-white dark:bg-dark-card text-gray-500 dark:text-[#A1A1AA] hover:text-orange-500 border border-gray-100 dark:border-dark-border px-4 py-1.5 rounded-full text-xs font-black transition-al transition-colors duration-300l">Tur</button>
        <button
          class="bg-white dark:bg-dark-card text-gray-500 dark:text-[#A1A1AA] hover:text-orange-500 border border-gray-100 dark:border-dark-border px-4 py-1.5 rounded-full text-xs font-black transition-al transition-colors duration-300l">Taman
          Bermain</button>
        <button
          class="bg-white dark:bg-dark-card text-gray-500 dark:text-[#A1A1AA] hover:text-orange-500 border border-gray-100 dark:border-dark-border px-4 py-1.5 rounded-full text-xs font-black transition-al transition-colors duration-300l">Spa
          & Gaya Hidup</button>
      </div>
      <a href="#"
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
    ...
    @foreach($activities as $a)
      <div
        class="bg-white dark:bg-dark-card rounded-3xl p-4 shadow-sm border border-gray-50 dark:border-dark-border group cursor-pointer hover:border-orange-200 transition-all flex flex-col h-full transition-colors duration-300">
