<div id="section-security" class="settings-section">
    <h1 class="text-2xl font-bold text-gray-800 mb-8">Akun & Keamanan</h1>
    <div class="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100 space-y-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="relative">
                    <input type="email" value="{{ auth()->user()->email }}" readonly
                        class="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl px-5 py-3 text-gray-500 outline-none cursor-not-allowed">
            ...
            <div>
                ...
                <input type="text" value="{{ auth()->user()->phone ?? '' }}" placeholder="+62 812 3456 7890"
                    name="phone"
                    class="w-full bg-white border-2 border-gray-100 rounded-2xl px-5 py-3 focus:border-orange-100 outline-none transition-all">
            </div>
        </div>

        <div class="pt-6 border-t border-gray-100">
            <h3 class="font-bold text-gray-800 mb-4">Password & Keamanan</h3>
            <div class="flex items-center justify-between p-4 bg-orange-50/50 rounded-2xl mb-4 text-sm">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Amankan akun Anda dengan verifikasi tambahan.</p>
                    </div>
                </div>
        ...
        <div class="pt-6 border-t border-gray-100">
            <h3 class="font-bold text-gray-800 mb-4">Aktivitas Login Terakhir</h3>
            <div class="space-y-3">
                <div class="flex items-center justify-between text-xs p-3 bg-gray-50 rounded-xl">
                    <div class="flex items-center gap-3">
                ...
                <div class="flex items-center justify-between text-xs p-3 bg-gray-100/50 rounded-xl text-gray-400">
                    <div class="flex items-center gap-3">
